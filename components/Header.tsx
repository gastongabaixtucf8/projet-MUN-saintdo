...
const socialLinks = [
  { href: 'https://www.instagram.com/mun_saintdo/', label: 'Instagram', Icon: InstagramIcon },
  { href: 'https://www.facebook.com/mun.saintdominique', label: 'Facebook', Icon: FacebookIcon },
  { href: 'https://x.com/mun_saintdo', label: 'X / Twitter', Icon: XIcon },
]
